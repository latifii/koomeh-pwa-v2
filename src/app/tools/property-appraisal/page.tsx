...
export const metadata: Metadata = {
  title: "کارشناسی آنلاین قیمت ملک | کومه",
  description: "برآورد اولیه قیمت ملک در محله‌های قم بر اساس مشخصات ملک.",
};
      ...
      <Container className="pb-section-sm">
        <header className="mb-6 max-w-2xl">
          ...
          <Typography as="h1" variant="h2" className="mt-2">
            کارشناسی اولیه قیمت ملک
          </Typography>
          <Typography variant="lead" className="mt-2 leading-7">
            با واردکردن مشخصات پایه، یک بازه تقریبی از ارزش روز ملک دریافت کنید.
          </Typography>
        </header>
