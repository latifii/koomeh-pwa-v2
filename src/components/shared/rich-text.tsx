...
function prepareHtml(value: string): string {
...
export function RichText({ html }: { html: string | null | undefined }) {
  ...
  return (
    <div
      className="rich-text grid gap-4 leading-8 text-foreground/90 [&_a]:text-brand [&_a]:underline [&_blockquote]:border-s-2 [&_blockquote]:border-brand [&_blockquote]:bg-muted/50 [&_blockquote]:p-4 [&_h1]:font-heading [&_h1]:font-bold [&_h2]:font-heading [&_h2]:font-bold [&_h3]:font-heading [&_h3]:font-bold [&_img]:h-auto [&_img]:max-w-full [&_img]:rounded-2xl [&_li]:my-1 [&_ol]:list-decimal [&_ol]:pe-5 [&_p]:m-0 [&_table]:w-full [&_table]:overflow-x-auto [&_ul]:list-disc [&_ul]:pe-5"
