...
export const PANEL_NAV_GROUPS: PanelNavGroup[] = [
  {
    ...
    items: [
      ...
      {
        href: routes.panel.estateReports,
        label: "گزارش‌های مشکل در املاک",
        icon: Flag,
        audience: "admin",
      },
      {
        href: routes.panel.estateEdits,
        label: "ویرایش‌های املاک",
        icon: FileClock,
        audience: "admin",
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      {
        href: routes.panel.contracts,
        label: "مدیریت قرارداد",
        icon: FileSignature,
        audience: "admin",
      },
      {
        href: routes.panel.posts,
        label: "مدیریت مطالب",
        icon: Newspaper,
        audience: "admin",
      },
      {
        href: routes.panel.locations,
        label: "استان، شهر و محله",
        icon: Map,
        audience: "admin",
      },
      {
        href: routes.panel.settings,
        label: "تنظیمات",
        icon: Settings,
        audience: "admin",
      },
