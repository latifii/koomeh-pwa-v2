...
const DETAIL_LABELS: ReadonlyArray<{
  ...
  { prefix: routes.panel.properties, suffix: "/new", label: "ثبت ملک" },
  ...
  { prefix: routes.panel.branches, suffix: "/edit", label: "ویرایش شعبه" },
  { prefix: routes.panel.branches, suffix: "/new", label: "شعبه تازه" },
  { prefix: routes.panel.contracts, suffix: "/edit", label: "ویرایش قولنامه" },
